...
extern NSString *PARAM_IDPW_LOGIN;
extern NSString *PARAM_USER_SIGNUP;
extern NSString *PARAM_CTN_ID_LOGIN_REQUEST;
extern NSString *PARAM_ID_SEARCH;
extern NSString *PARAM_PASSWORD_RESET;
extern NSString *PARAM_AUTH_MOBILE;
extern NSString *PARAM_ATHN_USER_CONVERSION_REQUEST;
extern NSString *PARAM_TOS_REQUEST;
extern NSString *PARAM_CONVERSION_REQUEST;
extern NSString *PARAM_ONEID_CONFIG;
extern NSString *PARAM_USER_MANUAL_SIGNUP;
extern NSString *PARAM_TEST_USER_SIGNUP;
extern NSString *PARAM_UFLIX_INFO;
extern NSString *PARAM_SNS_CONVERSION_REQUEST;
extern NSString *PARAM_SNS_REVOKE;
extern NSString *PARAM_SNS_LOGOUT;
extern NSString *PARAM_SNS_AUTO_LOGIN;
extern NSString *PARAM_ID_CHANGE_REQUEST;
extern NSString *PARAM_VTID_CHANGE_REQUEST;
extern NSString *PARAM_CTN_LOGIN_REQUEST;

extern NSString *PARAM_2ND_CERTIFY_REQUEST;
extern NSString *PARAM_FIDO_CONFIG;
